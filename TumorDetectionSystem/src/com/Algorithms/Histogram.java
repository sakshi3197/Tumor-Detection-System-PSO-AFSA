...
public class Histogram {
    ...
    public static HistogramDataset dataset;
    public static XYBarRenderer renderer;
    
    static void Create(BufferedImage input) {
...
//        private final BufferedImage image = getImage();
    ...
    public static class VisibleAction extends AbstractAction {
